...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <br>
        <div class="content">
            <form action="controller_editar_per.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="card col-md-6" style= "border: 1px solid #606060" >
                        <div class="card-header" style= "background-color: #27AE60; color: #ffffff">
                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" value="<?=$nombre_url;?>" class="form-control" name="nombre_url" >
                                </div>
                                </div> 
                                <br>
                                <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" value="<?=$url_url;?>"class="form-control" name="url_url">
                                </div>
                                </div>                         
                                        <br>
                                        <center>
